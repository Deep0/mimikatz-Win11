...
const MSV1_0_PRIMARY_HELPER msv1_0_primaryHelper[] = {
	...
	{FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, LogonDomainName),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, UserName),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, isIso),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, isNtOwfPassword),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, isLmOwfPassword),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, isShaOwPassword),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, isDPAPIProtected),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, NtOwfPassword), FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, LmOwfPassword), FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, ShaOwPassword),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, DPAPIProtected),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_11_H24, NtOwfPassword)},
};
